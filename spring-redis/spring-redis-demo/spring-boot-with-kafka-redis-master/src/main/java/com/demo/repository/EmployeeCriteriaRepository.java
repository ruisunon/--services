...
import com.demo.model.EmployeePage;
import com.demo.model.EmployeeSearchCriteria;
...
public class EmployeeCriteriaRepository {
    ...
    private Predicate getPredicate(EmployeeSearchCriteria employeeSearchCriteria,
        ...
        if(Objects.nonNull(employeeSearchCriteria.getPhoneNumber())){
            predicates.add(criteriaBuilder.equal(employeeRoot.get("phoneNumber"),employeeSearchCriteria.getPhoneNumber()));
        }
