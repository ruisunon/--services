...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(final @NotNull HttpSecurity http) throws Exception {
    http.authorizeRequests()
            .antMatchers(HttpMethod.GET, "/api/redis/employee/**").authenticated()
            .antMatchers(HttpMethod.GET, "/api/redis/employer/**").authenticated()
            .antMatchers(HttpMethod.DELETE, "/api/redis/employee/**").authenticated()
            .antMatchers(HttpMethod.DELETE, "/api/redis/employer/**").authenticated()
            .antMatchers("/api/redis/adminUser/**").authenticated()
            .and()
            .cors()
            .and()
            .csrf().disable()
