...
import com.microservices.user.Models.Role;
import com.microservices.user.Models.User;
import com.microservices.user.Repositories.IUserRepository;
...
public class UserService {
    ...
    public User FindByUsername(String username){
        ...
        var result = repository.findAll().stream().filter(u->u.getUsername() == username).collect(Collectors.toList());
