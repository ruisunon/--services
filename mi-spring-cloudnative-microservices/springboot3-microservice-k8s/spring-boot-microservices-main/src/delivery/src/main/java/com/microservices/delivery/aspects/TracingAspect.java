package com.microservices.delivery.aspects;
...
public class TracingAspect {
    ...
    public TracingAspect(){
        ...
        Tracing tracing = Tracing.newBuilder().currentTraceContext(braveCurrentTraceContext).supportsJoin(false)
                ...
                .propagationFactory(BaggagePropagation.newFactoryBuilder(B3Propagation.FACTORY)
                        ...
                        .build())
                .sampler(Sampler.ALWAYS_SAMPLE).localServiceName("delivery-service").addSpanHandler(spanHandler).build();
    ...
    @Pointcut(value = "execution(* com.microservices.delivery.Services.*.*(..) )")
