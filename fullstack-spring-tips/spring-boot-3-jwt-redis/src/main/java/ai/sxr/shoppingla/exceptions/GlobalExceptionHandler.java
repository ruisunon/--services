package ai.sxr.shoppingla.exceptions;

import ai.sxr.shoppingla.product.models.response.GenericResponse;
import ai.sxr.shoppingla.product.models.response.InvalidDataResponse;
