...
package com.rxs.inventoryservice.config.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
            "@within(com.rxs.inventoryservice.config.logging.Loggable) || "
                    + "@annotation(com.rxs.inventoryservice.config.logging.Loggable)")
