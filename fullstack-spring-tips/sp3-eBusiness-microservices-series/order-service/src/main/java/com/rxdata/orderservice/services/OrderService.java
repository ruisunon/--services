...
package com.rxdata.orderservice.services;

import com.rxdata.common.dtos.OrderDto;
import com.rxdata.common.dtos.OrderItemDto;
import com.rxdata.orderservice.entities.Order;
import com.rxdata.orderservice.exception.ProductNotFoundException;
import com.rxdata.orderservice.mapper.OrderMapper;
import com.rxdata.orderservice.model.response.PagedResult;
import com.rxdata.orderservice.repositories.OrderRepository;
...
public class OrderService {
    ...
    public PagedResult<OrderDto> findAllOrders(
        ...
        List<CompletableFuture<OrderDto>> completableFutureList = page.getContent().stream()
                        .map(order -> CompletableFuture.supplyAsync(() -> this.orderMapper.toDto(order)))
                        .toList();
    ...
    public OrderDto saveOrder(OrderDto orderDto) {
        ...
        if (productsExistsAndInStock(productIds)) {
            ...
            this.template.send(AppConstants.ORDERS_TOPIC,
